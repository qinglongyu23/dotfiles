# Generated by Powerlevel10k configuration wizard on 2024-03-05 at 14:14 CST.
...
() {
  ...
  # Max number of untracked files to show. If there are more, they'll be counted but not listed individually.
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_MAX_NUM=-1

  # Max number of modified files to show. If there are more, they'll be counted but not listed individually.
  typeset -g POWERLEVEL9K_VCS_MODIFIED_MAX_NUM=-1
  ...
  typeset -g POWERLEVEL9K_VCS_UNSTAGED_ICON="%F{$yellow}?"
  ...
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='(${P9K_CONTENT}%F{$POWERLEVEL9K_VCS_FOREGROUND})'
...
function prompt_word_at() {
  p10k segment -f 255 -t 'at'
}
function prompt_word_in() {
