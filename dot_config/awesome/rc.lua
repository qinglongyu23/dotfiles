...
awful.rules.rules = {
	...
	-- Rule to remove the title bar on Conky
	{ rule = { class = "system_conky" }, properties = { titlebars_enabled = true } },
...
client.connect_signal("manage", function(c)
	...
	if c.class == "conky" then
		-- don't add to tasklist or pager
		c.skip_taskbar = true
		c.floating = true
		-- remove titlebar
		awful.titlebar.hide(c)
		-- make window unable to be moved
		c.is_fixed = true
	end
...
--awful.spawn.with_shell("xfce4-panel --quit")
